...
<title><%= request.getAttribute("pageTitle") %> - The Book Nook</title>
...
<script type="text/javascript">
	function validateFormInput(){
		var fieldEmail = document.getElementById("cust_email");	

		var fieldPassword = document.getElementById("cust_password");	
